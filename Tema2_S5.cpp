...
class Trapez : public Paralelogram {
    ...
    public:
        Trapez(Punct stanga_jos, Punct colt_opus, float latura, float latura2, float baza2):
            Patrat(stanga_jos, latura),
            Paralelogram(stanga_jos, colt_opus, latura, latura2)
            {
            // presupunem ca latura = AB si latura2 = BC
            // 
            // La fel ca la Paralelogram
            // B = (stanga_jos.x + latura, stanga_jos.y)
            // D = (colt_opus.x - latura2, colt_opus.y)
            // 
            // BC == latura2
            //
                valid = 0;
